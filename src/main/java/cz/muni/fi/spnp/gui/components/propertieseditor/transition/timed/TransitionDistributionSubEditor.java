...
/**
 * Base class for the transition distribution subeditors.
 */
public abstract class TransitionDistributionSubEditor extends SubEditor<TransitionDistributionViewModel> {
}
