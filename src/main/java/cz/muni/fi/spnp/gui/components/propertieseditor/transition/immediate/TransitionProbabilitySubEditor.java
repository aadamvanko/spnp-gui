...
/**
 * Base class for the transition probability subeditors.
 */
public abstract class TransitionProbabilitySubEditor extends SubEditor<TransitionProbabilityViewModel> {
}
